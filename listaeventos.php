                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tr>
                                        ...
                                        <td>MCP</td>
                                        <td>forum@eventos</td>
                                        <td>Conferencia anual de eventos</td>
                                    </tr>
                                    <tr>
                                        <td>Campus Party</td>
                                        <td>MCI</td>
                                        <td>campus-party@campuse.ro</td>
                                        <td>Conferencia de tecnologia</td>
                                    </tr>
                                <tr>
                                        <td>StartUp CASE</td>
                                        <td>ABStartUp</td>
                                        <td>contato@abstartup.com.br</td>
                                        <td>Conferencia anual de StartUps</td>
                                    </tr>
                                    <tr>
                                        <td>Marketing Conference</td>
                                        <td>Trak.to</td>
                                        <td>paulo.tenorio@trak.to</td>
                                        <td>Conferencia anual de marketing</td>
                                    </tr>
